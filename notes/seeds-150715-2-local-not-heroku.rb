...
class Seed
  ...
  def generate_images
    count = 0
    Image.populate(500_000, :per_query => 100_000) do |image|
  ...
  def generate_venues
    count = 0
    Venue.populate(500_000, :per_query => 100_000) do |venue|
  ...
  def generate_events
    ...
    Event.populate(500_000, :per_query => 100_000) do |event|
  ...
  def generate_items
    ...
    puts "#{users} sellers"
    Item.populate(500_000, :per_query => 100_000) do |item|
  ...
  def generate_orders
    count = 0
    users = User.count
    Order.populate(50_000, :per_query => 50_000) do |order|
  ...
  def generate_order_items
    ...
    orders = Order.count
    items = Item.count
    OrderItem.populate(500_000, :per_query => 100_000) do |order_item|
