  ...
  def generate_images
    @images = Image.create([
      { title: "Blazers vs. Nuggets",
        ...
        img: "http://imgick.oregonlive.com/home/olive-media/width620/img/blazers_impact/photo/12345131-mmmain.jpg" },
      { title: "Hannibal Burress",
        description: "Hannibal Burress Headshot",
        img: "http://www.slate.com/content/dam/slate/blogs/browbeat/2015/07/10/hannibal_buress_interview_137_minutes_and_a_cartful_of_groceries_with_the/456431988-comedian-hannibal-buress-performs-at-stand-up-live.jpg.CROP.promovar-mediumlarge.jpg" },
      { title: "Pitbull and Enrique Iglesias",
        description: "Pitbull and Enrique Being Bosses",
        img: "http://www.billboard.com/files/styles/promo_650/public/media/pitbull-enrique-iglesias-2014-billboard-650x430.jpg" },
      { title: "ABBA!!!",
        description: "The whole gang",
        img: "http://gaygamer.net/images/abba.jpg" },
      { title: "Portland Timbers",
        description: "The Portland Timbers",
        img: "https://upload.wikimedia.org/wikipedia/commons/0/0c/Kinsol-Trestle-Timbers.JPG" },
      { title: "Missing",
        description: "crowd",
        img: "http://www.software.ac.uk/sites/default/files/images/content/crowd.jpg" }
    ])
  end
  ...
  def generate_items
    100.times do |i|
      ...
      item = Item.create!(
        ...
        event_id: event.id,
        user_id: user.id,
        ticket: ("http://franticjapyoshi.up.seesaa.net/image/IMG_9699.JPG"
        ))
